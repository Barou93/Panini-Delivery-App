...
module.exports.register = async (req, res, next) => {
  ...
  if (name === "" && lastname === "" && email === "" && password === "") {
    const errors = {
      name: "Veuillez remplir les champs obligatoires",
      lastname: "Veuillez remplir les champs obligatoires",
      email: "Veuillez remplir les champs obligatoires",
      password: "Veuillez remplir les champs obligatoires",
    };
